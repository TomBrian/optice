<div class="form bg-white shadow-sm">
            <form action="" id="protected" class="services-form" method="POST">
                ...
                <div class="input-wrapper my-2 flex">
                 ...
                 <div class="dropdown allow-focus input-wrapper">
                     <div class="dropdown-toggle my-2 flex justify-content-between" id="triggerId" data-toggle="dropdown" aria-haspopup="true"
                             aria-expanded="false">
        ...
        <script>
          jQuery(($)=>{
             // Check if the services field has selected services
          })
        </script>