...
<div class="container-fluid py-5">
  <div class="container blog-header">
    ...
    <h1 class="my-4 text-left">
      Explore the latest stories about what is happening in the world of web and technology.
      From news,tutorials to updates and everything you need to know about.
    </h1>
    <hr>
    <div class="container-fluid cats">
    <a href="<?php bloginfo('url')?>/blog"><div class="badge p-3 all-caps badge-primary">All</div></a>
      <?php
